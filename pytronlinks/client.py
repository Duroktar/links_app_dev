...
class Client(object):
    ...
    def GetConfirmation(self, trigger_var='Answer', confirm=None, on_yes=None, on_no=None, timeout=15):
        """
...
#            r = requests.get(url)
            ...
            if r.code == 200:
                j = r.readlines()
                # print(j)
                response = literal_eval(j[3].strip())
...
if __name__ == '__main__':
    ...
    print "It's {} outside today.".format(temp)
    # print 'here'
    ...
    if ai.GetConfirmation(confirm='Would you like to see the grammar list?',
                                 on_yes="No problem. Here you go.",
                                 on_no="Okay. All tests have passed except the ones that haven't."):
        from pprint import pprint
        pprint(ai.GetGrammarList())
